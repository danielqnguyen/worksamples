...
import InviteKeyForm from "./InviteForm";
...
class InviteKey extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentUser: "",
  ...
  componentDidMount = () => {
    ...
    this.setState({ expiration: eDate, modifiedBy: this.props.user.email });
  };
...
export default connect(mapStateToProps)(InviteKey);
